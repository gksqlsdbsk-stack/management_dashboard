...
- [x] 착수 전: 05 §4 CSV 매핑 보강과 사용자 승인 [A-51]
- [x] `/dashboard/export/`, `/monthly-report/export/` (UTF-8 BOM CSV) [A-43, A-51, 05 §4]
- [x] 화면의 `CSV 다운로드` 버튼(fetch → Blob)
- [x] 전체 흐름 수동 점검: 직원 입력/업로드/제출 → 관리자 현황 → 대시보드/리포트 → 다운로드
- [x] 취합 시간 단축 목표(부서당 8시간 → 1시간 미만) 관점의 사용성 점검 메모
- [x] 문서 정리: README, CLAUDE.md, specs 최신화, 99-assumptions 중 확정 항목 반영
- [x] 알려진 제한 사항 기록 (배포 미포함, 그룹웨어 연동 미포함)
